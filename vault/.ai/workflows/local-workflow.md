...
One `.md` file per task, in `vault/tasks/`. Put the schema fields in YAML front-matter and name the file with the ordering prefix so the folder sorts correctly.
