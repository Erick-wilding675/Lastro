...
| Item | Onde | Nota |
|---|---|---|
| Especificação completa do produto | `.ai/docs/` | Reescrita para o case KRILLTECH |
| Decisões de arquitetura ARD-01 a ARD-05 | `.ai/docs/ARD.md` | Neo4j, FastAPI, React, integração via API, explicação materializada |
| Design system (paleta, tipografia, tokens) | `.ai/ui_guidelines.md` | Tema escuro, paleta Síntese, wordmark Sora |
